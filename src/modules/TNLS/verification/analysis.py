...
CLI summary
-----------
  python -m src.modules.TNLS.verification --base-samples HCLS.json --target-samples TNLS_merged.json \\
...
from src.modules.TNLS.verification.comparison import compare_1n
